# Question 3
Carrying on from Question 2, we need to also add a configurations class for production (called Prod). It should inherit from our Dev class. It should override the setting DEBUG and force it to be True always. The other setting it should override is SECRET_KEY, which should be read from the environment using a SecretValue.
...
- Create the Prod class as a subclass of Dev
- Set SECRET_KEY to configurations.values.SecretValue()
- Set DEBUG to False
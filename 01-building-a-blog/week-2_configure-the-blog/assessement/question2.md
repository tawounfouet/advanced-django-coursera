# Question 2
Carrying on from Question 1, we want our ALLOWED_HOSTS setting to be read from environment variables to make it easier to set. Make the necessary changes to the Dev class to allow this. Hint, you’ll need to use one of the configurations.values.Value subclasses.
...
- Import configurations.values
- Set ALLOWED_HOSTS to configurations.values.ListValue([])